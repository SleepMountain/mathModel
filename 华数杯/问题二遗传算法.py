...
def calculate_cielab_distance(target_xyz, dye_xyz):
    if target_xyz[1] / 1.16 > 0.008856:
        L = (target_xyz[1] / 1.16) ** (1 / 3)
    else:
        L = 903.3 * target_xyz[1]

    if L != 0:
        a = 500 * ((target_xyz[0] ** (1 / 3) - dye_xyz[0] ** (1 / 3)) / L)
        b = 200 * ((dye_xyz[1] ** (1 / 3) - dye_xyz[2] ** (1 / 3)) / L)
    else:
        a = 0
        b = 0
