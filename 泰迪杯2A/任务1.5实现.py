...
correlation_output_file = r'D:\桌面\竞赛\泰迪杯2\A\A题-自动化生产线数据分析\附件1\correlation_result.xlsx'
...
correlation_matrix = result[['推出状态_计数', '抓取状态_计数', '安装状态_计数', '检测状态_计数']].corr()

print("相关系数矩阵:")
print(correlation_matrix)

correlation_matrix.to_excel(correlation_output_file)
print("相关系数矩阵已保存至:", correlation_output_file)